...
Use the Kepler Hub as the entrypoint and each declared repository,
...
- Ask for planning or review in natural language. Kepler infers the focused
...
instructions, verified Kepler bridges, and existing focused skills are the
