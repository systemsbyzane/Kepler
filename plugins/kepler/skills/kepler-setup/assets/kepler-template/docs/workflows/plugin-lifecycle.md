...
The installed Kepler plugin and this generated Hub have separate
...
```text
What changed in the latest Kepler version?
```

```text
Upgrade my Kepler plugin without changing this Hub or my repositories.
Show me the patch notes before applying anything.
```

The installed `$kepler-upgrade` skill handles these requests. Explicit
