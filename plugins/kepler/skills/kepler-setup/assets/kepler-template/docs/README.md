...
This folder is the shared operating layer for the Kepler Hub. It provides
...
- [Plugin lifecycle](workflows/plugin-lifecycle.md) - upgrade the installed
  Kepler plugin without regenerating this Hub or changing repositories.
...
- [Kepler workflow](workflow.md) - use the ArchitectureMap, Plan, dispatch,
  results, status, and approval model.
- [Coordination-layer architecture](architecture/coordination-layer.md) - understand
...
- [Plan intake](templates/plan-intake.md) - define intent, ownership, scope, and
  evidence.
...
- [Repository bridge](templates/repo-bridge.md) - add the minimum Kepler
