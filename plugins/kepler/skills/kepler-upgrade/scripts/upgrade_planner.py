#!/usr/bin/env python3
"""Create a read-only Kepler plugin upgrade plan from Codex JSON state."""
...
def resolve_target_manifest(
    ...
    if releases.get("schema_version") != "kepler-releases/v1":
...
def build_plan(
    ...
    return {
        "schema_version": "kepler-upgrade-plan/v1",
        "status": status,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--plugin", default="kepler")
