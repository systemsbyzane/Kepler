---
name: kepler-ci
description: Coordinate trustworthy CI/CD and software-delivery work through Kepler. Use when a user asks about failing or slow checks, pipeline diagnosis, build and test workflows, release automation, artifact provenance, caching, matrices, runners, permissions, secrets, environments, approvals, promotion, rollback, or changing GitHub Actions, GitLab CI, Jenkins, or another delivery system. Natural CI/CD intent should trigger this skill; explicit invocation is optional.
---
