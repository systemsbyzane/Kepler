...
```json
{
  "schema_version": "kepler.stig-evaluations/v1",
  "benchmark": {
...
| --- | --- |
| application or service source | `$kepler-development` |
| Helm, Kubernetes YAML, or chart defaults | `$kepler-charts` |
| build, scan, signing, release, or delivery pipeline | `$kepler-ci` |
| cluster, cloud, identity, network, or shared platform | `$kepler-platform` |
| program evidence, package language, or POA&M | `$kepler-compliance` |
